...
public class GuiStagingAreaEditorSimple extends GuiBase
{
    ...
    public GuiStagingAreaEditorSimple(String schematicId, StagingAreaEntry areaEntry)
    {
        this.schematicId = schematicId;
        this.areaEntry = areaEntry;
        this.title = "备货区配置（简易模式）";
    ...
    private static class ButtonListener implements IButtonActionListener
    {
        ...
        private final GuiStagingAreaEditorSimple gui;

        public ButtonListener(Type type, GuiStagingAreaEditorSimple gui)
        {
            this.type = type;
            this.gui = gui;
        }
