    ...
    public void runTest(ClientGameTestContext ctx) {
        ...
        try (var server = ctx.worldBuilder().createServer();
            ...
            int warehouseId = server.computeOnServer(s -> {
                ...
                chestPositions[0] = placeChestWithItem(player.getWorld(), base.add(2, 0, 0), Items.STONE);
                chestPositions[1] = placeChestWithItem(player.getWorld(), base.add(4, 0, 0), Items.DIRT);
